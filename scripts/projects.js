const data = [
  ...
  },
  {
    ...
    description:
      "Master's thesis exploring the techniques for classification of musical instruments. The final model is deployed into an Android application.",
  ...
  },
  {
    ...
    stack: ["python", "html"],
    description:
      "Custom IR system aimed at comparing vector space models of increasing complexity. This is done by analyzing the evaluation metrics of each model on our custom dataset of scientific books and articles.",
  ...
  },
  {
    ...
    stack: ["java", "javafx"],
    description:
      "A 2D platform game inspired by the classic Super Mario. The goal is to complete each level while avoiding obstacles. The player can see how good they are compared to the AI player, train their own AI, import custom levels, etc.",
...
class Card extends React.Component {
  render() {
    ...
    return React.createElement(
      ...
      React.createElement(
        "div",
        { className: "card hoverable", style: { margin: "0" } },
        React.createElement(
          "div",
